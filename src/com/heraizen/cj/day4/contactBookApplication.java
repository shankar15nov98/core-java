...
public class contactBookApplication {
	...
	static void start()
	{
		...
		listOfContact.add(new contactBookApplication("Shankar", "7010794336", "ranjith@gmail.com"));
		listOfContact.add(new contactBookApplication("Boopalan", "9442498827", "boopalan@gmail.com"));
		listOfContact.add(new contactBookApplication("Shiva", "8144888060", "shiva@gmail.com"));
		listOfContact.add(new contactBookApplication("Karthick", "9574332776", "karthick@gmail.com"));
		listOfContact.add(new contactBookApplication("Faizan", "8754032668", "faizan@gmail.com"));
